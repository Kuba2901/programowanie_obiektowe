...
import pl.edu.pg.eti.ksg.po.lab2.symulatorwycieczki.ludzie.Architekt;
import pl.edu.pg.eti.ksg.po.lab2.symulatorwycieczki.ludzie.Czlowiek;
import pl.edu.pg.eti.ksg.po.lab2.symulatorwycieczki.ludzie.Informatyk;
...
import pl.edu.pg.eti.ksg.po.lab2.symulatorwycieczki.ludzie.StudentAWF;
import pl.edu.pg.eti.ksg.po.lab2.symulatorwycieczki.ludzie.StudentKSG;
import pl.edu.pg.eti.ksg.po.lab2.symulatorwycieczki.ludzie.Trapkowski;
...
public class JavaLab2 {
    public static void main(String[] args) {
        ...
        uczestnicy.add(new Informatyk("Jakub", "Nenczak", Czlowiek.Plec.MEZCZYZNA));
        uczestnicy.add(new Trapkowski("Wojciech", "Trapkowski", Czlowiek.Plec.MEZCZYZNA));
        uczestnicy.add(new StudentAWF("Maciek", "Nysiak", Czlowiek.Plec.MEZCZYZNA));
        uczestnicy.add(new Architekt("Zuza","Zajaczek", Czlowiek.Plec.KOBIETA));
        ...
        symulator.dodajSluchaczaPostepow((ElementWycieczki elementWycieczki, int lp, int liczbaElementow) -> {
            System.out.println("Aktualny etap: " + (lp+1) + ".");
        });
