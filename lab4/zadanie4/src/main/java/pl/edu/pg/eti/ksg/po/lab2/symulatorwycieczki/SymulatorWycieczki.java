...
public class SymulatorWycieczki {
    ...
    // Sluchacze
    // Set<SluchaczPostepow> sluchacze = new HashSet<SluchaczPostepow>();
    SluchaczPostepow sluchacz;
    ...
    public void symuluj() {
        ...
        for(pozycjaGrupy = 0; pozycjaGrupy < wycieczka.getLiczbaElementowWycieczki(); pozycjaGrupy++) {
            ...
            if (elementWycieczki instanceof Atrakcja) {
                ...
                for (Uczestnik u: grupa.getUczestnicy()) {
                    u.reagujNaAtrakcje(atrakcja, czasWycieczki);
                }

            }

            sluchacz.aktualizujPostep(elementWycieczki, pozycjaGrupy, pozycjaGrupy);
            
            System.out.println();
           
        }
        System.out.printf("Trasa zajęła grupie %.2f h, przeszli oni %.2f GOT.\n", czasWycieczki, pokonanyDystans);
        System.out.println("Maksymalna dlugosc etapu: " + wycieczka.getMaksymalnaDlugosc());
